...
<!--grid column-->
                            ...
                            <div class="col-md-10 order-2 col-lg-6 order-lg-1">
                                ...
                                <form action="assets/php/login-action.php" method="post" class="mx-1 mx-md-4">
...
<!--last grid row-->
                                    ...
                                    <div class="justify-content-center d-flex mx-4 mb-3 mb-lg-4">
                                        <button type="submit" class="justify-content-center btn btn-primary btn-lg" value="submitted" name="submitted">Log In</button>
                                    </div>
                    ...
                    <div class="text-center mb-2">
                        Don't already have an account? <a href="register.php" class="register-link">Register.</a>
                    </div>
                </div>
            </div>
        </div>
